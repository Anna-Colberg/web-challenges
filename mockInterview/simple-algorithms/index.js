...
function maxOfTwoNumbers(num1, num2) {
  // TODO:  The larger number is returned
...
/* 
0 - function bekommt 2 Parameter übergeben
1 - Überprüfen, welche Zahl größer ist
2 - eine if und else Abfrage benutzen
3 - wenn "" größer ist als "" soll die Funktion "" wiedergeben, wenn nicht,
soll sie den Wert "" wiedergeben*/
...
/* 
0 - Start with longest = "Inception" 9
1 - visit every single word "Psycho"
2 - i will use the "length" property to see how long is the word: 6
3 - i will compare the length of the current word against the length of longest variable 6 vs 9 
4 - if the length of the current word is LARGER than the length of the longest
then, update the longest word to equal the current word
